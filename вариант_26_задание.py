...
# ==============================================================================
# ЗАДАНИЕ 1: Извл(признаки X, Y, Z индексируются как столбцы data 0,1,2 соответственно)
# Подсказка: используйте слайсы (slices) деките значения из data ля выделения подмассива из массива numpy.ndarray
# ==============================================================================
X = data[:,0]
Y = data[:,1]
Z = data[:,2]
